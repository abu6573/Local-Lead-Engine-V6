      ...
      <main>
          ...
          <div className="shell">
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
              ...
              <Reveal delay={120} y={16} className="rounded-2xl bg-cream p-6 border border-black/[0.04]">
                ...
                <p className="mt-1 text-[0.8125rem] text-warm">Click-to-lead benchmark</p>
              </Reveal>
              ...
              <Reveal delay={180} y={16} className="rounded-2xl bg-cream p-6 border border-black/[0.04]">
                ...
                <p className="mt-1 text-[0.8125rem] text-warm">100% Exclusive inbound calls</p>
              </Reveal>
            </div>
          </div>
        </section>
            ...
            <div className="mx-auto max-w-3xl text-center">
              ...
              <Reveal delay={160} y={16}>
                <p className="mt-5 body-lg">
                  We bid exclusively on bottom-of-funnel commercial and residential search terms. No generic informational queries, no low-budget repair clutter.
                </p>
              </Reveal>
            </div>
        ...
        <section className="py-20 bg-white border-y border-black/[0.06]">
          <div className="shell">
            <div className="mx-auto max-w-3xl text-center">
              <Reveal y={18}>
                <Eyebrow icon="ShieldAlert">Why Generic Ads Fail</Eyebrow>
              </Reveal>
              <MaskHeading
                lines={['Overcoming Common Advertising', 'Traps in Your Industry']}
                className="mt-5 h-section"
                delay={80}
              />
            </div>
        ...
        <section className="py-20 sm:py-24">
          <div className="shell">
            <div className="mx-auto max-w-3xl text-center">
              <Reveal y={18}>
                <Eyebrow icon="CheckCircle2">Custom Campaign Architecture</Eyebrow>
              </Reveal>
              <MaskHeading
                lines={['Battle-Tested Strategies For', trade.title]}
                className="mt-5 h-section"
                delay={80}
              />
            </div>
          ...
          <section className="py-20 bg-cream-deep border-y border-black/[0.06]">
            <div className="shell">
              <div className="mx-auto max-w-3xl text-center">
                ...
                <MaskHeading
                  lines={['Real Client Growth In Action', matchingCaseStudy.title]}
                  className="mt-5 h-section"
                  delay={80}
                />
              </div>
                  ...
                  <div className="lg:col-span-7 space-y-5">
                    <div>
                      <span className="text-xs font-bold uppercase tracking-wider text-brand">
                        {matchingCaseStudy.category} • Verified Campaign Result
                      </span>
                    ...
                    <div className="pt-2">
                      ...
                      >
                        <span>Read Full {matchingCaseStudy.category} Case Study Breakdown</span>
                        <span>&rarr;</span>
                      </Link>
                    </div>
                  </div>
        ...
        <section className="py-20 bg-cream">
          <div className="shell">
            ...
            <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
              {otherTrades.slice(0, 4).map((other) => (
                <Link
                  key={other.slug}
                  to={`/trades/${other.slug}`}
                  className="group rounded-2xl border border-black/[0.06] bg-white p-6 shadow-soft hover:shadow-lift hover:border-brand/30 transition-all flex flex-col justify-between"
                >
                  <div>
